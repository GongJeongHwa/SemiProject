...
public interface MypageDao {
	...
	//페이징
	String selectWishedSql_paging = " SELECT * FROM (SELECT * FROM (SELECT ROWNUM, PLACE_HEART.* FROM PLACE_HEART) WHERE ROWNUM>=?) WHERE ROWNUM <=? ";
	String countSql = " SELECT COUNT(*) AS COUNT FRON PLACE_HEART";
