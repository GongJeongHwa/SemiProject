...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<h2>
				나만의 여행 일정을 만들어보세요&nbsp;&nbsp;<button type="button" class="btn btn-light" id="btn" onclick="location.href='<%=request.getContextPath()%>/schedule/createSchedule_sk.jsp'">&nbsp;여행짜기&nbsp;<img src="./img/icons/arrow-right-circle-fill.svg" alt="Bootstrap" width="30" height="30"></button>
			</h2>
		</div>
		<br><br>
		<div class="row">
